...
use AppBundle\Model\map\PlayersTableMap;
...
abstract class BasePlayersPeer
{
    ...
    const OM_CLASS = 'AppBundle\\Model\\Players';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AppBundle\\Model\\map\\PlayersTableMap';
    ...
    const SURNAME = 'players.surname';

    /** the column name for the name field */
    const NAME = 'players.name';

    /** the column name for the team field */
    const TEAM = 'players.team';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Surname', 'Name', 'Team', 'Age', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'surname', 'name', 'team', 'age', ),
        BasePeer::TYPE_COLNAME => array (PlayersPeer::ID, PlayersPeer::SURNAME, PlayersPeer::NAME, PlayersPeer::TEAM, PlayersPeer::AGE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SURNAME', 'NAME', 'TEAM', 'AGE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'surname', 'name', 'team', 'age', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Surname' => 1, 'Name' => 2, 'Team' => 3, 'Age' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'surname' => 1, 'name' => 2, 'team' => 3, 'age' => 4, ),
        BasePeer::TYPE_COLNAME => array (PlayersPeer::ID => 0, PlayersPeer::SURNAME => 1, PlayersPeer::NAME => 2, PlayersPeer::TEAM => 3, PlayersPeer::AGE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SURNAME' => 1, 'NAME' => 2, 'TEAM' => 3, 'AGE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'surname' => 1, 'name' => 2, 'team' => 3, 'age' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PlayersPeer::ID);
            $criteria->addSelectColumn(PlayersPeer::SURNAME);
            $criteria->addSelectColumn(PlayersPeer::NAME);
            $criteria->addSelectColumn(PlayersPeer::TEAM);
            $criteria->addSelectColumn(PlayersPeer::AGE);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePlayersPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \AppBundle\Model\map\PlayersTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PlayersPeer::ID) && $criteria->keyContainsValue(PlayersPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.PlayersPeer::ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PlayersPeer::ID);
            $value = $criteria->remove(PlayersPeer::ID);
            if ($value) {
                $selectCriteria->add(PlayersPeer::ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PlayersPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PlayersPeer::DATABASE_NAME);
        $criteria->add(PlayersPeer::ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PlayersPeer::DATABASE_NAME);
            $criteria->add(PlayersPeer::ID, $pks, Criteria::IN);
