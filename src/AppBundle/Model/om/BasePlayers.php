...
abstract class BasePlayers extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'AppBundle\\Model\\PlayersPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PlayersPeer::ID;
        }
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[] = PlayersPeer::SURNAME;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PlayersPeer::NAME;
        }
    ...
    public function setTeam($v)
    {
        ...
        if ($this->team !== $v) {
            $this->team = $v;
            $this->modifiedColumns[] = PlayersPeer::TEAM;
        }
    ...
    public function setAge($v)
    {
        ...
        if ($this->age !== $v) {
            $this->age = $v;
            $this->modifiedColumns[] = PlayersPeer::AGE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PlayersPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PlayersPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PlayersPeer::SURNAME)) {
            $modifiedColumns[':p' . $index++]  = '`surname`';
        }
        if ($this->isColumnModified(PlayersPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(PlayersPeer::TEAM)) {
            $modifiedColumns[':p' . $index++]  = '`team`';
        }
        if ($this->isColumnModified(PlayersPeer::AGE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlayersPeer::ID)) $criteria->add(PlayersPeer::ID, $this->id);
        if ($this->isColumnModified(PlayersPeer::SURNAME)) $criteria->add(PlayersPeer::SURNAME, $this->surname);
        if ($this->isColumnModified(PlayersPeer::NAME)) $criteria->add(PlayersPeer::NAME, $this->name);
        if ($this->isColumnModified(PlayersPeer::TEAM)) $criteria->add(PlayersPeer::TEAM, $this->team);
        if ($this->isColumnModified(PlayersPeer::AGE)) $criteria->add(PlayersPeer::AGE, $this->age);
    ...
    {
        $criteria = new Criteria(PlayersPeer::DATABASE_NAME);
        $criteria->add(PlayersPeer::ID, $this->id);
